//Upon clicking the reset password link in the email thi spage is shown 
          ...
          <form onSubmit={handleResetPaassword} className="space-y-4">
            ...
            <div className="relative">
              <input
                ...
                value={password} // FIX 1: Changed from confirmPassword to password
              ...
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)} // FIX 2: Toggles visibility instead of clearing text
            ...
            <button
              type="submit"
              // FIX 3: Added 'bg-gradient-to-r' to make the colors show
              className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-400 text-white rounded-lg font-semibold hover:opacity-90 transition-opacity"
            >
              Reset Password
            </button>
          </form>
